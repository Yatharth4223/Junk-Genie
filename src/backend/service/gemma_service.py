    ...
    response = client.models.generate_content(
        ...
        config=types.GenerateContentConfig(
            system_instruction=(
                ...
                "2. action_description_for_imagen: the physical scene at the END of this step. "
                "Still photograph. No motion words. No arrows. Describe the cumulative assembly state — "
                "what has been built so far, including all previous steps.\n\n"
                "For item_visual_descriptions:\n"
                "- Ratios only, no measurements\n"
                "- Specific color terms\n"
                "- Explicit texture\n"
                "- No words: approximately, roughly, about, natural, rustic\n\n"
